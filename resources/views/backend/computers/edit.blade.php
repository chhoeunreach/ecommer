...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="px-3 px-md-2rem mb-4">
            <form action="{{route('admin.computers.update', ['computer' => $computer->id])}}" method="POST" enctype="multipart/form-data" id="aizSubmitForm">
                        ...
                        <div class="border border-gray-300 rounded-2 mb-4">
                            <div class="bg-white border-radius-10px px-3 px-lg-4 py-3 py-lg-4">
                                ...
                                <div class="row gutters-5">
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" placeholder="{{translate('Name')}}" name="name" class="form-control" value="{{ $computer->name }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control aiz-selectpicker" name="brand_id" data-live-search="true">
                                                ...
                                                @foreach ($brands as $brand)
                                                    <option value="{{ $brand->id }}" @if($computer->brand_id == $brand->id) selected @endif>{{ $brand->getTranslation('name') }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description" rows="5" class="form-control">{{ $computer->description }}</textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row gutters-5">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" min="0" step="0.01" placeholder="{{translate('Discount')}}" name="discount" class="form-control" value="{{ $computer->discount }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control aiz-selectpicker" name="discount_type">
                                                <option value="amount" @if($computer->discount_type == 'amount') selected @endif>{{translate('Flat')}}</option>
                                                <option value="percent" @if($computer->discount_type == 'percent') selected @endif>{{translate('Percent')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                        ...
                        <div class="border border-gray-300 rounded-2 mb-4">
                            <div class="bg-white border-radius-10px px-3 px-lg-4 py-3 py-lg-4">
                                ...
                                @php
                                    ...
                                    $selected_attribute_ids = json_decode($computer->attributes, true) ?? [];
                                    $selected_choice_options = json_decode($computer->choice_options) ?? [];
                                @endphp
                                ...
                                <div class="form-group row gutters-5 mb-0">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control aiz-selectpicker" data-live-search="true" data-selected-text-format="count" name="colors[]" id="colors" multiple @if(count($selected_colors) < 1) disabled @endif>
                                            @foreach (\App\Models\Color::orderBy('name', 'asc')->get() as $key => $color)
                                            <option value="{{ $color->code }}" data-color-id="{{ $color->id }}" data-content="<span><span class='size-15px d-inline-block mr-2 rounded border' style='background:{{ $color->code }}'></span><span>{{ $color->name }}</span></span>"
                                                @if(in_array($color->code, $selected_colors)) selected @endif></option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-1 align-content-center">
                                        <label class="aiz-switch aiz-switch-blue mb-0">
                                            <input value="1" type="checkbox" name="colors_active" @if(count($selected_colors) > 0) checked @endif>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="d-none" aria-hidden="true">
                                        ...
                                        <div class="col-md-9">
                                            <select name="choice_attributes[]" id="choice_attributes" class="form-control aiz-selectpicker" data-selected-text-format="count" data-live-search="true" multiple data-placeholder="{{ translate('Choose Attributes') }}">
                                                @foreach ($attributes as $attribute)
                                                    <option value="{{ $attribute->id }}" @if(in_array($attribute->id, $selected_attribute_ids)) selected @endif>{{ $attribute->getTranslation('name') }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="customer_choice_options mb-3 d-none" id="customer_choice_options" aria-hidden="true">
                                        @foreach ($selected_choice_options as $choice_option)
                                    ...
                                    <div class="row gutters-5 mt-3">
                                        <div class="col-md-6">
                                            <div class="form-group mb-2 mb-lg-3">
                                                ...
                                                <input type="number" lang="en" value="{{ optional($computer->stocks->first())->qty ?? 0 }}" step="1" integer-only name="current_stock" class="form-control" placeholder="10">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-2 mb-lg-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="sku" name="sku" value="{{ optional($computer->stocks->first())->sku ?? '' }}" placeholder="{{ translate('Computer SKU') }}">
                            ...
                            <div class="bg-white border-radius-10px px-3 px-lg-4 py-3 py-lg-4">
                                ...
                                <div class="form-group d-flex align-items-center mb-0">
                                    <label class="aiz-switch aiz-switch-success mb-0 mr-3">
                                        <input type="checkbox" name="has_warranty" id="has_warranty" value="1" onchange="toggleWarranty()" @if($computer->has_warranty) checked @endif>
                                        <span></span>
                                    </label>
                                    <span class="fs-14 fw-400">{{translate('Enable warranty for this computer')}}</span>
                                </div>
                                <div class="form-group mt-3" id="warranty_selection" style="display: {{ $computer->has_warranty ? 'block' : 'none' }};">
                                    ...
                                    <select class="form-control aiz-selectpicker" name="warranty_id" data-live-search="true">
                                        ...
                                        @foreach ($warranties as $warranty)
                                            <option value="{{ $warranty->id }}" @if($computer->warranty_id == $warranty->id) selected @endif>{{ $warranty->getTranslation('text') }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="row gutters-5">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mb-2 mb-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="meta_title" placeholder="{{translate('Meta Title')}}" value="{{ $computer->meta_title }}">
                                        </div>
                                    </div>
                                    <!-- Description -->
                                    <div class="col-12">
                                        <div class="form-group mb-2 mb-lg-3">
                                            <label class="col-from-label fs-14 fw-500">{{translate('Description')}}</label>
                                            <textarea name="meta_description" rows="5" class="form-control">{{ $computer->meta_description }}</textarea>
                                        </div>
                                    </div>
                                    <!-- Meta Image -->
                                    <div class="col-12">
                                        <div class="form-group mb-2 mb-lg-3">
                                            ...
                                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                ...
                                                <input type="hidden" name="meta_img" class="selected-files" value="{{ $computer->meta_img }}">
                                            </div>
                                ...
                                <div class="mb-3">
                                    <div class="d-flex align-items-center mt-3 mb-2">
                                        <div class="btn-group" role="group" style="border: 1px solid #e2e5ec; border-radius: 8px; overflow: hidden; background: #f8f9fa;">
                                            <label class="mb-0 btn btn-sm px-4 fw-600 @if($computer->status == 1) bg-success text-white @else text-muted @endif" id="btn-active" onclick="setPublished(true)" style="border-radius: 0; box-shadow: none; cursor: pointer;">
                                                {{ translate('Active') }}
                                            </label>
                                            <label class="mb-0 btn btn-sm px-4 fw-600 @if($computer->status != 1) bg-danger text-white @else text-muted @endif" id="btn-disabled" onclick="setPublished(false)" style="border-radius: 0; box-shadow: none; cursor: pointer;">
                                                {{ translate('Disabled') }}
                                            </label>
                                        </div>
                                        <input value="1" type="checkbox" name="published" id="real-published-checkbox" @if($computer->status == 1) checked @endif style="display:none;">
                                        <script>
                            ...
                            <div class="bg-white border-radius-10px px-3 px-lg-4 py-3 py-lg-4">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                        ...
                                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                        <input type="hidden" name="thumbnail_img" class="selected-files" value="{{ $computer->thumbnail_img }}">
                                    </div>
                                    <div class="file-preview box sm"></div>
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                                        ...
                                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                        <input type="hidden" name="gallery" class="selected-files" value="{{ $computer->gallery }}">
                                    </div>
                                    <div class="file-preview box sm"></div>
                                </div>
                            </div>
                ...
                <div class="row align-items-center mb-4">
                    <div class="col-12 text-right">
                        <button type="submit" class="btn btn-primary w-200px fs-14 fw-700">{{ translate('Update Computer') }}</button>
                    </div>
                </div>
...
<script>
    ...
    function update_sku(){
        $.ajax({
           type:"POST",
           url:'{{ route('admin.computers.sku_combination_edit') }}',
