...
@endphp
@if(!empty($top_brands_products))
    <!-- brands -->
    <div class="aiz-carousel dashboard-box-carousel half-outside-arrow arrow-inactive-none" data-items="{{ $data_items }}" data-xl-items="{{ $data_xl_items }}"
