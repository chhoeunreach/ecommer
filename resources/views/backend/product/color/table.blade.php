    ...
    <table class="table mb-0" id="aiz-data-table">
        <thead>
            <tr>
                ...
                @canany(['delete_color', 'edit_color'])
                ...
                <td class="hide-sm align-middle" data-label="Color & Code">
                    <div class="row gutters-5 w-200px w-md-200px mw-200">
                        <div class="col d-flex align-items-center">
                            <span class='size-20px d-inline-block mr-2 rounded border' style='background:{{ $color->code }}'></span>
                            <span
                                class="fs-14 fw-400 text-dark">
                                    {{$color->code}}
                            </span>
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-sm">
                                    <div class="table-options">
                                        @if(auth()->user()->can('edit_color'))
                                            <a href="javascript:void(0);" title="{{ translate('Edit') }}" onclick="edit_color({{ $color->id }})"
                                        ...
                                        <a href="javascript:void(0)"
                                            class="d-flex text-danger align-items-center px-20px py-10px hov-bg-light hov-text-blue" onclick="singleDelete({{$color->id}})"
