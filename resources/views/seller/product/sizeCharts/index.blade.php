        ...
        <div class="col-10 col-sm-10 col-lg-10 mx-auto">
            ...
            <div class="card">
                <div
                    ...
                    <div class="">
                        @if (get_setting('seller_can_add_size_chart'))
                            <a href="{{ route('seller.size-charts.create') }}" id=""
...
@section('script')
    <script type="text/javascript">
        ...
        function single_delete(sizeChartId) {
            $.ajax({
                url: "{{ route('seller.size-charts.destroy', ':id') }}".replace(':id', sizeChartId),
                type: 'GET',
        ...
        function bulk_delete() {
            ...
            $.ajax({
                ...
                url: "{{route('seller.bulk-size-chart-delete')}}",
                type: 'POST',
                data: data,
                cache: false,
                contentType: false,
        ...
        function getSizeCharts(slug, page = 1) {
            ...
            $.ajax({
                url: `{{ route('seller.size_charts.filter') }}?page=${page}`,
                method: 'GET',
        ...
        function showSizeChartDetail(id, name) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('seller.size-charts.show', '') }}/" + id,
                data: {},
        ...
        function loadProducts(categoryId, searchKey, wholeCategoryMode) {
            ...
            $.post('{{ route('seller.sizeChart_products.search') }}', {
        ...
        function assignCategoryOrProducts() {
            ...
            $.ajax({
                url: "{{ route('seller.assignCategoryOrProducts.update') }}",
                method: 'POST',
                data: {
                    _token: AIZ.data.csrf,
