...
@section('meta')
    ...
    @php
        ...
        $p_meta_title = $detailedProduct->meta_title ?: $detailedProduct->getTranslation('name');
        $p_meta_description = $detailedProduct->meta_description ? $detailedProduct->meta_description : \Illuminate\Support\Str::limit(strip_tags($detailedProduct->getTranslation('description')), 160);
        $p_meta_image = $detailedProduct->meta_img ? uploaded_asset($detailedProduct->meta_img) : uploaded_asset($detailedProduct->thumbnail_img);
    @endphp
