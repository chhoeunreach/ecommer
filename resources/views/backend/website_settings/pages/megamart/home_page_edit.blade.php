				...
				<div class="tab-content">
					...
					<div class="tab-pane fade" id="banner_4" role="tabpanel" aria-labelledby="banner-4-tab">
						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
							...
							<input type="hidden" name="types_lang[{{ $lang }}][]" value="home_banner4_images">
							<input type="hidden" name="types_lang[{{ $lang }}][]" value="home_banner4_links">
					...
					<div class="tab-pane fade" id="banner_5" role="tabpanel" aria-labelledby="banner-5-tab">
						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
							...
							<input type="hidden" name="types_lang[{{ $lang }}][]" value="home_banner5_images">
							<input type="hidden" name="types_lang[{{ $lang }}][]" value="home_banner5_links">
					...
					<div class="tab-pane fade" id="banner_6" role="tabpanel" aria-labelledby="banner-6-tab">
						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
							...
							<input type="hidden" name="types_lang[{{ $lang }}][]" value="home_banner6_images">
							<input type="hidden" name="types_lang[{{ $lang }}][]" value="home_banner6_links">
					...
					<div class="tab-pane fade" id="featuredPreorder" role="tabpanel" aria-labelledby="banner-1-tab">
						<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
							...
							<input type="hidden" name="types_lang[{{ $lang }}][]" value="featuredPreorder_images">
							<input type="hidden" name="types_lang[{{ $lang }}][]" value="featuredPreorder_links">
