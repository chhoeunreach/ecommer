@if($new_top_sellers->count() > 0)
    <!-- sellers -->
    <div class="aiz-carousel dashboard-box-carousel half-outside-arrow arrow-inactive-none" data-items="6.5" data-xl-items="4.5"
        ...
        @foreach($new_top_sellers as $key => $top_sellers_product)
            <div class="top_sellers_product_table top-products-table table-responsive c-scrollbar-light @if ($key == 0) show @endif" 
                ...
                <table class="table dashboard-table mb-0">
                    <thead>
                        <tr class="fs-12 fw-400 text-secondary">
