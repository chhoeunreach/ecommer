                        ...
                        <ul class="list-inline mb-0 pl-0 hor-swipe c-scrollbar-light">
                            ...
                            @foreach ($menuLabels as $key => $value)
                                @if ($loop->index < 5)
                                    ...
                                    <a href="{{ header_menu_url($menuLinks[$key]) }}" class="fs-13 px-3 py-3 d-inline-block middle-text-color-visibility fw-700 header_menu_links hov-bg-black-10
                                            @if (is_active_header_menu($menuLinks[$key])) active @endif" style="color: {{ $middleHeaderTextColor }}">
                                        {{ translate($value) }}
                                    </a>
                                    </li>
                                @endif
                                ...
                                <li class="list-inline-item mr-0 dropdown position-static">
                                    ...
                                    <div class="dropdown-menu py-0 header-drop">
                                        @for ($i = 5; $i < $totalMenus; $i++)
                                            <a href="{{ header_menu_url($menuLinks[$i]) }}" class="dropdown-item fs-13 py-2 px-3 violet-dropdown text-dark
                                                       @if (is_active_header_menu($menuLinks[$i])) active @endif
