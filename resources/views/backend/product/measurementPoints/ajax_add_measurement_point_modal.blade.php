...
<div class="global-right-offcanvas-body position-absolute h-100 px-30px pt-20px">
    ...
    <div class="form-group mb-3">
        ...
        <input type="text" placeholder="{{ translate('Name') }}" name="measurement_point_name" class="form-control" required>
    </div>
...
<div class="w-100 px-30px position-absolute bottom-0 bg-white global-right-offcavas-footer pt-20px pb-20px">
    <div class="d-flex justify-content-end">
        <button type="button" class="fs-14 fw-700 py-10px px-20px btn btn-primary" id="add-measurement-point">
            {{ translate('Confirm') }}
        </button>
    </div>
</div>